...
<%--            <%
            ...
            %>
            <li><a href='util/news?opr=readNew&nid=<%=news.getNid() %>'><b><%=news.getNtitle() %>
            </b></a></li>
            <% } %>--%>
            <c:forEach var="news" items="${requestScope.list1}">
                <li>
                    <a href='util/news?opr=readNew&nid=${news.nid}'><b>${news.ntitle}</b></a>
                </li>
            </c:forEach>
        </ul>
    </div>
...
<%--            <%
            ...
            <c:forEach var="news" items="${requestScope.list2}">
                <li>
                    <a href='util/news?opr=readNew&nid=${news.nid}'><b>${news.ntitle}</b></a>
                </li>
            </c:forEach>
...
<%--            <%
            ...
            <c:forEach var="news" items="${requestScope.list3}">
                <li>
                    <a href='util/news?opr=readNew&nid=${news.nid}'><b>${news.ntitle}</b></a>
                </li>
            </c:forEach>
