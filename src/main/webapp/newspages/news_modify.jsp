...
<div id="main">
    ...
    <div id="opt_area">
        <ul class="classlist">
            ...
            <form action="../util/news?opr=modifyNews&nid=<%=news.getNid()%>"
                ...
                <p>
                    ...
                    <select name="ntid">
                        ...
                        <option value='<%= topic.getTid()%>' selected="selected"><%= topic.getTname()%>
                        </option>
                        <%} else {%>
            ...
            <table width="80%" align="left">
                ...
                <tr>
                    ...
                    <td><a href="../util/news?opr=deleteComment&cid=<%=comment.getCid()%>&nid=<%=news.getNid()%>">删除</a>
                    </td>
                </tr>
                <tr>
