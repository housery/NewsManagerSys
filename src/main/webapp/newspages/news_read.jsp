...
<div id="header">
    <div id="top_login">
        <form action="${pageContext.request.contextPath}/util/user?opr=login" method="post">
            <label> 登录名 </label>
        ...
        <div class="content">
            <ul class="classlist">
                <table width="80%" align="center">
                    <tr width="100%">
                        <td colspan="2" align="center"><%=n.getNtitle() %>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        ...
                        <td align="left">发布时间：<%=n.getNcreatedate() %>
                        </td>
                    </tr>
                    <tr>
            ...
            <ul class="classlist">
                <table width="80%" align="center">
                    ...
                    <tr>
                        <td colspan="6"><%=comment.getCcontent()%>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="6">
            ...
            <ul class="classlist">
                <form action="" method="post">
                    ...
                    <table width="80%" align="center">
                        ...
                        <tr>
                            <td>
                                <input type="button" id="commentSubmit" name="submit" value="发表">
                            </td>
                        </tr>
                    </table>
                </form>
...
<script src="${pageContext.request.contextPath}/js/jquery_3.3.0.js"></script>
